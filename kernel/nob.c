...
int main(int argc, char **argv)
{
    ...
    if (!walk_directory(&dirs, &c_sources, &asm_sources, SRC_FOLDER))
        return 1;
    ...
    */
    ...
    if (!mkdir_if_not_exists("build/iso_root") || !mkdir_if_not_exists("build/iso_root/boot") || !mkdir_if_not_exists("build/iso_root/boot/limine") || !mkdir_if_not_exists("build/iso_root/EFI") || !mkdir_if_not_exists("build/iso_root/EFI/BOOT"))
        return 1;

    if (!nob_copy_file("build/bin/open95", "build/iso_root/boot/open95"))
        return 1;
